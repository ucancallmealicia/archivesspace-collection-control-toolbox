...
def get_archobj_instances():
    try:
        ...
        if connect == None:
            ...
            left join housed_at_rlshp har on har.id = location.id 
...
#LOGIN HEADER LABEL
ttk.Label(mainframe, text='Step 1: Log in to ArchivesSpace MySQL Database: ', font=('Arial', 13)).grid(column=2, row=1, columnspan=3, sticky=W)
...
username_input = ttk.Entry(mainframe, width=30, textvariable=sqlhostname)
username_input.grid(column=2, row=4, sticky=W+E)
#SQL Database Name
ttk.Label(mainframe, text='Database Name: ', font=('Arial', 11)).grid(column=3, row=3, sticky=W)
username_input = ttk.Entry(mainframe, width=30, textvariable=sqldbname)
username_input.grid(column=3, row=4, sticky=W+E)

#SQL Database Username
ttk.Label(mainframe, text='Database Username: ', font=('Arial', 11)).grid(column=2, row=5, sticky=W)
password_input = ttk.Entry(mainframe, width=30, textvariable=sqlusername)
password_input.grid(column=2, row=6, sticky=W+E)

#SQL Port Name
ttk.Label(mainframe, text='Database Port: ', font=('Arial', 11)).grid(column=3, row=5, sticky=W)
username_input = ttk.Entry(mainframe, width=30, textvariable=sqlport)
username_input.grid(column=3, row=6, sticky=W+E)

#SQL Database Password
ttk.Label(mainframe, text='Database Password: ', font=('Arial', 11)).grid(column=2, row=7, sticky=W)
password_input = ttk.Entry(mainframe, width=30, textvariable=sqlpassword, show='*')
password_input.grid(column=2, row=8, sticky=W+E)
...
#SQL Actions
getaos = ttk.Button(mainframe, text='Get archival object instances', width=30, command=get_archobj_instances).grid(column=2, row=22, sticky=W)
getlocations = ttk.Button(mainframe, text='Get locations', width=30, command=get_locations).grid(column=3, row=22, sticky=W)
gettcs = ttk.Button(mainframe, text='Get top containers', width=30, command=get_top_containers).grid(column=2, row=23, sticky=W)
getcps = ttk.Button(mainframe, text='Get container profiles', width=30, command=get_container_profiles).grid(column=3, row=23, sticky=W)
...
ttk.Label(mainframe, textvariable=txt_file, width=90, font=('Arial', 10)).grid(column=2, row=29, columnspan=3, sticky=W)
