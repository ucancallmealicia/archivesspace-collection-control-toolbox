...
#LOGIN HEADER LABEL
ttk.Label(mainframe, text='Step 1: Log in to the ArchivesSpace API: ', font=('Arial', 13)).grid(column=2, row=1, sticky=W)

#AS API URL
ttk.Label(mainframe, text='ArchivesSpace API URL: ', font=('Arial', 11)).grid(column=2, row=2, sticky=W)
api_entry = ttk.Entry(mainframe, width=30, textvariable=api_address)
api_entry.grid(column=2, row=3, sticky=(W, E))
#AS Username
ttk.Label(mainframe, text='ArchivesSpace Username: ', font=('Arial', 11)).grid(column=2, row=4, sticky=W)
username_input = ttk.Entry(mainframe, width=30, textvariable=username_entry)
username_input.grid(column=2, row=5, sticky=(W, E))
#AS Password
ttk.Label(mainframe, text='ArchivesSpace Password: ', font=('Arial', 11)).grid(column=2, row=6, sticky=W)
...
ttk.Label(mainframe, textvariable=login_confirmed, font=('Arial', 11)).grid(column=3, row=5, sticky=E)

#-------STEP 2: SELECT INPUT CSV------#

#SELECT INPUT CSV HEADER
ttk.Label(mainframe, text='Step 2: Select input CSV: ', font=('Arial', 13)).grid(column=2, row=9, sticky=W)
...
ttk.Label(mainframe, text='File selected: ', font=('Arial', 11)).grid(column=2, row=10, sticky=W)
ttk.Label(mainframe, textvariable=filename_input, width=90, font=('Arial', 10)).grid(column=2, row=11, columnspan=3, sticky=W)

#-------STEP 3: SELECT OUTPUT DIRECTORY------#

#OUTPUT TXT BUTTON AND LABEL INDICATING WHICH DIRECTORY IS OPEN
ttk.Label(mainframe, text='Step 3: Select output directory: ', font=('Arial', 13)).grid(column=2, row=13, sticky=W)
selectfilebutton = ttk.Button(mainframe, text='Select Output Directory', command=prewritefile).grid(column=3, row=13, sticky=E)
ttk.Label(mainframe, text='Directory selected: ', font=('Arial', 11)).grid(column=2, row=14, sticky=W)
ttk.Label(mainframe, textvariable=txt_name, width=50, font=('Arial', 10)).grid(column=2, row=15, columnspan=3, sticky=W)

#-------STEP 4: CHOOSE AN ACTION------#

#CHOOSE AN ACTION HEADER
ttk.Label(mainframe, text='Step 4: Choose an action: \n', font=('Arial', 13)).grid(column=2, row=16, sticky=W)
...
ttk.Label(mainframe, text='\nStep 5: Review output: ', font=('Arial', 13)).grid(column=2, row=21, sticky=W)
ttk.Label(mainframe, textvariable=script_status, font=('Arial', 11)).grid(column=3, row=21, sticky=E)
...
ttk.Label(mainframe, text='File selected: ', font=('Arial', 11)).grid(column=2, row=22, sticky=W)
ttk.Label(mainframe, textvariable=txt_file, width=90, font=('Arial', 10)).grid(column=2, row=23, columnspan=3, sticky=W)
...
#OUTPUT TEXT BOX
ttk.Label(mainframe, text='Output: ', font=('Arial', 11)).grid(column=2, row=24, sticky=W)
printoutput = tkst.ScrolledText(mainframe, wrap=WORD, width=50, height=10)
printoutput.grid(column=2, row=25, columnspan=3, sticky=W)

#RECORD UPDATE SUMMARY LABELS
ttk.Label(mainframe, text='Record updates attempted: ', width=30, font=('Arial', 11)).grid(column=2, row=26, sticky=E)
ttk.Label(mainframe, textvariable=update_attempts, width=30, font=('Arial', 10)).grid(column=3, row=26, sticky=W)
ttk.Label(mainframe, text='Records updated successfully: ', width=30, font=('Arial', 11)).grid(column=2, row=27, sticky=E)
ttk.Label(mainframe, textvariable=updates_success, width=30, font=('Arial', 10)).grid(column=3, row=27, sticky=W)
ttk.Label(mainframe, text='Elapsed time: ', width=30, font=('Arial', 11)).grid(column=2, row=28, sticky=E)
ttk.Label(mainframe, textvariable=elapsed_time, width=30, font=('Arial', 10)).grid(column=3, row=28, sticky=W)
